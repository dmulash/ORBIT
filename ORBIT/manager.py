...
class ProjectManager:
    ...
    def project_capex(self):
        ...
        site_auction = self.project_params.get("site_auction_price", 105989395)
        site_assessment = self.project_params.get("site_assessment_cost", 52994698)
        construction_plan = self.project_params.get(
            "construction_plan_cost", 1059894
        )
        installation_plan = self.project_params.get(
            "installation_plan_cost", 264973
        )
