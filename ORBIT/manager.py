...
class ProjectManager:
    ...
    def project_capex(self):
        ...
        """
        site_auction = self.project_params.get("site_auction_price", 100000000)
        site_assessment = self.project_params.get("site_assessment_cost", 50000000)
        construction_plan = self.project_params.get(
            "construction_plan_cost", 1000000
        )
        installation_plan = self.project_params.get(
            "installation_plan_cost", 250000
        )
